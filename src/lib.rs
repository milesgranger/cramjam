...
mod tests {
    ...
    fn test_snappy_raw_into_round_trip() {
        ...
        let n_bytes = crate::snappy::internal::compress_raw_into(&data, &mut Cursor::new(&mut compressed_buffer)).unwrap();
        ...
        let n_bytes = crate::snappy::internal::decompress_raw_into(&compressed_buffer[..n_bytes], &mut Cursor::new(&mut decompressed_buffer)).unwrap();
